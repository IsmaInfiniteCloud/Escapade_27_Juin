...
const App = () => {
  ...
  const { setDetailsHebergementModalOpen } = useModalContext();

  // Cette fonction est appelée lorsque l'utilisateur clique sur le bouton pour ouvrir DetailsHebergementModal
  const handleOpenModal = () => {
    setDetailsHebergementModalOpen(true);
  };
            ...
            <div className="hebergementsAll__container row my-3">
              {hebergementsAll.map((hebergement, index) => (
                <div
                  ...
                  key={index}
                >
                  <div className="card my-3" onClick={handleOpenModal}>
                    <div
                      style={{
